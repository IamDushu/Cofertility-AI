  ...
  return (
    <LampContainer>
      ...
      <motion.p
        ...
        className="md:mx-40 mx-10 mt-8 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-md font-medium tracking-tight text-transparent md:text-md"
      >
      ...
      <motion.p
        ...
        className="md:mx-40 flex gap-5  md:gap-10 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-md  tracking-tight text-transparent md:text-md"
      >
        <Link
          href={"https://dushyanth.in"}
          className="font-bold"
        ...
        <Link
          ...
          target="_blank"
        >
          <IconBrandLinkedinFilled size={30} color="white" />
        </Link>
      </motion.p>
    </LampContainer>
  );
